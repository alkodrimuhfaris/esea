...
const items = [
  {
    src: abtUsCard1,
    text:
      'Kami bergerak untuk menciptakan masa depan yang cerah dimana hasil laut segar dapat diakses dengan mudah oleh seluruh masyarakat Indonesia.',
  },
  {
    src: abtUsCard2,
    text:
      'Kami menginspirasi seluruh masyarakat Indonesia agar senantiasa mengkonsumsi hasil laut yang penuh nutrisi dan berkembang bersama anak-anak bangsa.',
  },
  {
    src: abtUsCard3,
    text:
      'Kami  bergerak dalam mengembangkan bisnis bersama para mitra nelayan/peternak ikan  dengan penuh inovasi agar senantiasa memberikan produk dan layanan terbaik.',
  },
];
    ...
    <section className="abtus mb-5" id="aboutus">
      ...
      <div className="row w-100 mx-auto d-flex justify-content-center px-5">
        {items.map((item, idx) => {
          return (
            <div
              className="col-md-6 col-sm-12 col-lg-3  my-3"
              key={`Card-cap-${idx}`}
            >
              <div className="card abtus__card">
                ...
                <div className="card-body">
                  <p className="kumbh-sans card-text">{item.text}</p>
                </div>
              </div>
            </div>
          );
